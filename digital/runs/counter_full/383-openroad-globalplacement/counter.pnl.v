module counter (clk,
 ...
 sky130_fd_sc_hd__and3_1 _18_ (.A(count[0]),
    .B(count[1]),
    .C(enable),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_08_));
 sky130_fd_sc_hd__and4_1 _19_ (.A(count[0]),
    .B(count[1]),
    .C(count[2]),
    .D(enable),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_09_));
 sky130_fd_sc_hd__nand2_1 _20_ (.A(count[3]),
    .B(_09_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_10_));
 sky130_fd_sc_hd__and2_1 _21_ (.A(count[5]),
    .B(count[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_11_));
 sky130_fd_sc_hd__and3_1 _22_ (.A(count[3]),
    .B(_09_),
    .C(_11_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_12_));
 sky130_fd_sc_hd__and4_1 _23_ (.A(count[3]),
    .B(count[6]),
    .C(_09_),
    .D(_11_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_13_));
 sky130_fd_sc_hd__and2_4 _24_ (.A(count[7]),
    .B(_13_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(overflow));
 sky130_fd_sc_hd__xor2_1 _25_ (.A(count[0]),
    .B(enable),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_00_));
 sky130_fd_sc_hd__a21oi_1 _26_ (.A1(count[0]),
    .A2(enable),
    .B1(count[1]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_14_));
 sky130_fd_sc_hd__nor2_1 _27_ (.A(_08_),
    .B(_14_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__nor2_1 _28_ (.A(count[2]),
    .B(_08_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _29_ (.A(_09_),
    ...
    .VPWR(VPWR),
    .Y(_02_));
 sky130_fd_sc_hd__or2_1 _30_ (.A(count[3]),
    .B(_09_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_16_));
 sky130_fd_sc_hd__and2_1 _31_ (.A(_10_),
    .B(_16_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_03_));
 sky130_fd_sc_hd__xnor2_1 _32_ (.A(count[4]),
    .B(_10_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_04_));
 sky130_fd_sc_hd__a31o_1 _33_ (.A1(count[3]),
    .A2(count[4]),
    .A3(_09_),
    .B1(count[5]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_17_));
 sky130_fd_sc_hd__and2b_1 _34_ (.A_N(_12_),
    .B(_17_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_05_));
 sky130_fd_sc_hd__xor2_1 _35_ (.A(count[6]),
    .B(_12_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__xor2_1 _36_ (.A(count[7]),
    .B(_13_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_07_));
 sky130_fd_sc_hd__dfrtp_4 _37_ (.CLK(clk),
    .D(_00_),
    .RESET_B(rst_n),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(count[0]));
 sky130_fd_sc_hd__dfrtp_4 _38_ (.CLK(clk),
    .D(_01_),
    .RESET_B(rst_n),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(count[1]));
 sky130_fd_sc_hd__dfrtp_4 _39_ (.CLK(clk),
    .D(_02_),
    .RESET_B(rst_n),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(count[2]));
 sky130_fd_sc_hd__dfrtp_4 _40_ (.CLK(clk),
    .D(_03_),
    .RESET_B(rst_n),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(count[3]));
 sky130_fd_sc_hd__dfrtp_4 _41_ (.CLK(clk),
    .D(_04_),
    .RESET_B(rst_n),
    .VGND(VGND),
    .VNB(VGND),
