module counter (clk,
 ...
 sky130_fd_sc_hd__and3_1 _18_ (.A(net3),
    .B(net4),
    .C(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_08_));
 sky130_fd_sc_hd__and4_1 _19_ (.A(net3),
    .B(net4),
    .C(net5),
    .D(net1),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _20_ (.A(net6),
    ...
    .VPWR(VPWR),
    .Y(_10_));
 sky130_fd_sc_hd__and2_1 _21_ (.A(net8),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_11_));
 sky130_fd_sc_hd__and3_1 _22_ (.A(net6),
    .B(_09_),
    .C(_11_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_12_));
 sky130_fd_sc_hd__and4_1 _23_ (.A(net6),
    .B(net9),
    .C(_09_),
    .D(_11_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_13_));
 sky130_fd_sc_hd__and2_1 _24_ (.A(net10),
    .B(_13_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__xor2_1 _25_ (.A(net3),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_00_));
 sky130_fd_sc_hd__a21oi_1 _26_ (.A1(net3),
    .A2(net1),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _27_ (.A(_08_),
    ...
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__nor2_1 _28_ (.A(net5),
    .B(_08_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _29_ (.A(_09_),
    ...
    .VPWR(VPWR),
    .Y(_02_));
 sky130_fd_sc_hd__or2_1 _30_ (.A(net6),
    .B(_09_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _31_ (.A(_10_),
    ...
    .VPWR(VPWR),
    .X(_03_));
 sky130_fd_sc_hd__xnor2_1 _32_ (.A(net7),
    .B(_10_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_04_));
 sky130_fd_sc_hd__a31o_1 _33_ (.A1(net6),
    .A2(net7),
    .A3(_09_),
    .B1(net8),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _34_ (.A_N(_12_),
    ...
    .VPWR(VPWR),
    .X(_05_));
 sky130_fd_sc_hd__xor2_1 _35_ (.A(net9),
    .B(_12_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__xor2_1 _36_ (.A(net10),
    .B(_13_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfrtp_2 _37_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(net3));
 sky130_fd_sc_hd__dfrtp_1 _38_ (.CLK(clknet_1_0__leaf_clk),
    .D(_01_),
    .RESET_B(net2),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _40_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(net6));
 sky130_fd_sc_hd__dfrtp_4 _41_ (.CLK(clknet_1_1__leaf_clk),
    .D(_04_),
    .RESET_B(net2),
    .VGND(VGND),
    .VNB(VGND),
